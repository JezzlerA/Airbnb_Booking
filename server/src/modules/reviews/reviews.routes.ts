...
reviewRouter.get(
  ...
  asyncHandler(async (req, res) => {
    ...
    const data = await reviewService.listReviews(req.params.propertyId as string, page, limit);
...
reviewRouter.patch(
  ...
  asyncHandler(async (req, res) => {
    ...
    await reviewService.updateReviewResponse(req.params.id as string, result.data.response, req.user!.id);
